...
const initialFormSate: formStateType = {
  first_name: '',
  last_name: '',
  email: '',
  gender: 'other',
...
export default function AddStudent() {
  const [formState, setFormState] = useState<formStateType>(initialFormSate)
  ...
  const handleChange = (name: keyof formStateType) => (e: React.ChangeEvent<HTMLInputElement>) => {
    setFormState((student) => ({ ...student, [name]: e.target.value }))
  }
